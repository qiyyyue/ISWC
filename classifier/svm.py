...
'''
def pre_t_data():
    f_max_vec = np.load("tvec/f_max_vec.npy")
    t_max_vec = np.load("tvec/t_max_vec.npy")
...
'''
def pre_data():
    f_max_train = np.load("bias/f_max_train.npy")
    t_max_train = np.load("bias/t_max_train.npy")
    f_max_test = np.load("bias/f_max_test.npy")
    t_max_test = np.load("bias/t_max_test.npy")
